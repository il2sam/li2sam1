...
async function logoutTeacher() { if (!firebaseStore.enabled) return; await firebaseStore.signOutTeacher(); setText("#teacher-auth-status", "교사 계정에서 로그아웃했습니다."); }
...
$("#teacher-logout-button").addEventListener("click", logoutTeacher);
